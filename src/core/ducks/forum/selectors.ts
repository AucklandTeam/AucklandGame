...
export const forumCategoriesSelector: SelectorResponse<
	ForumState['categories']
> = ({ forum }) => forum.categories

export const forumTopicsSelector: SelectorResponse<ForumState['topics']> = ({
	forum
}) => forum.topics

export const forumCommentsSelector: SelectorResponse<
	ForumState['comments']
