...
export const addTopic = request<Topic, NewTopicForm>({method: 'POST', baseURL: '/', url: ApiLocation.TOPIC})

export const getTopics = request<Topic[], ParamGetTopics>({method: 'GET', baseURL: '/', url: ApiLocation.TOPICS})

export const getTopic = request<Topic, {topicId: number}>({method: 'GET', baseURL:'/', url: ApiLocation.TOPIC})
