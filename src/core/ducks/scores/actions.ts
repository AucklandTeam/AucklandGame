...
export const addUserToLeaderBoardAction = createAction<number>(
...
export const seLeaderBoardData = createAction<Nullable<UserLeaderBoard[]>>(
	leaderBoardActions.setLeaderBoardSuccess
)

export const setLeaderBoardFailed = createAction<string>(
	leaderBoardActions.setLeaderBoardFailed
)
